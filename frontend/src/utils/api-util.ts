...
import { CommonRequest, CommonResponse, Method, StatusCode, SuccessOrNot } from "@/models/common/RestApi";
    ...
    switch (request.method) {
        ...
        case Method.DELETE:
            config = {
                ...
                headers: {
                    Accept: 'application/json',
                    ...(request?.bodyParams ? { 'Content-Type': 'application/json' } : {}),
                    ...(request?.headers || {}),
                },
                params: request?.queryParams || {},
                responseType: request?.responseType || 'json',
    ...
    instance.interceptors.response.use(
        async (response: any): Promise<any> => {
            ...
            if (commonResponse.statusCode && commonResponse.statusCode === StatusCode.SESSION_EXPIRE) {
                ...
                commonResponse.statusCode && commonResponse.statusCode === StatusCode.NOT_AUTHORIZED_EXCEPTION
            ) {
